 ...
 */
final class Version20230425064508 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sous_rubrique CHANGE name name VARCHAR(255) NOT NULL, CHANGE rub_id rubrique_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sous_rubrique CHANGE name name VARCHAR(50) NOT NULL, CHANGE rubrique_id rub_id INT DEFAULT NULL');
